...
Original file is located at
    https://colab.research.google.com/drive/1ObECv_hGk0_bVd5fs41saXz9vHELtpfO
...
data_preparada=data_preparada.reindex(columns=variables,fill_value=0) #reindex comparar
data_preparada.head()
...
# Recortar medida de error del modelo
st.warning("El modelo tiene un error del 0.12% (mape: error porcentual)")