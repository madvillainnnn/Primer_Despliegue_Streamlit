...
Original file is located at
    https://colab.research.google.com/drive/1hhYXIACBlFSNTp2JJuocrfGjaA7HkRhc
...
#Instalación de la librería (si no está disponible en el entorno)
#XGBoost
...
modelSVM = SVR(kernel='rbf', C=5) #'linear', 'poly'->degree, 'rbf', 'sigmoid', 'precomputed'
